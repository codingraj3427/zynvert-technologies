...
const LogoIcon = () => (
  <svg height="40" viewBox="0 0 100 100">
    <path fill="#FF6B6B" d="M50 0 L100 25 L100 75 L50 100 L0 75 L0 25 Z" />
...
const popularCategories = [
    { name: 'Lithium-Ion Batteries', image: 'https://placehold.co/300x300/FF6B6B/ffffff?text=Li-Ion' },
    { name: 'LiFePO4 Batteries', image: 'https://placehold.co/300x300/4ECDC4/ffffff?text=LiFePO4' },
    { name: 'Integrated Inverters', image: 'https://placehold.co/300x300/3A3A3A/ffffff?text=Inverter' },
    { name: 'Solar Inverters', image: 'https://placehold.co/300x300/FF6B6B/ffffff?text=Solar' },
...
/**
 * NEW Section: Showcase of recently launched products
 */
            ...
            <div className="showcase-section">
                <div className="showcase-left">
                    ...
                    <ul className="showcase-category-list">
                        {showcaseCategories.map(cat => <li key={cat}><a href={`/category/${toUrlFriendly(cat)}`}>{cat}</a></li>)}
                    </ul>
                </div>
        ...
        <footer className="footer">
            <div className="footer-content">
                <div className="footer-column about">
                    ...
                    <p className="phone-number">+91 9110976419</p>
                ...
                <div className="footer-column links">
                    <h4>Categories</h4>
                    <ul>
                       {footerCategories.map(cat => <li key={cat}><a href={`/category/${toUrlFriendly(cat)}`}>{cat}</a></li>)}
                    </ul>
                </div>
                <div className="footer-column links">
                    <h4>Our Policies</h4>
                    <ul>
                        {footerPolicies.map(policy => <li key={policy}><a href={`/policy/${toUrlFriendly(policy)}`}>{policy}</a></li>)}
                    </ul>
                </div>
                 <div className="footer-column contact">
                    <h4>Contact Us</h4>
                    <p>57, T.N. Banerjee Road, Panihati, Kolkata - 700114, West Bengal, India</p>
